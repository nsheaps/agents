...
description: |
  ...
  user: "Break down the refactor into tasks and assign to the team"
...
8. Triage issues by business priority
...
- When creating issues or tasks, include links to relevant context so assignees have what they need without hunting
...
- **All teammates busy**: Queue tasks and assign when teammates become available
