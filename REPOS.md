...
> **Status:** v1.3 — Nate moved `tilt` (→ archive) and `changed-files` (→ stale) out of scope on [`#175`](https://github.com/nsheaps/agents/issues/175) (2026-05-25 05:46Z). Tier 2 now has 21 entries. v1.2 base: folded 23-entry Tier 2 from #175 scope triage. v1.1 base: Q1/Q2/Q3 resolved per Nate Discord [1508331380239634652](https://discord.com/channels/1490863845252665415/1497431286661517353/1508331380239634652) — .openclaw stays as research artifact; aux repos added (op-exec, homebrew-devsetup, .github); repo-level only, not branches/worktrees.
