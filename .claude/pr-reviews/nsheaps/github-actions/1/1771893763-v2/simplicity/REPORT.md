...
The original finding L3 explicitly recommended: _"validate/normalize AUTO_SYNC at the top of the script alongside the other input assignments."_ That recommendation was not followed.
