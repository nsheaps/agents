...
3. **Force alternative hypotheses** — Before accepting any explanation, write down at least TWO possible causes:
   - One that blames the external tool/system
   - One that blames your own work or inputs
   - Test BOTH before accepting either. If you can only think of one explanation, you haven't thought hard enough.

4. **Verify each theory before accepting it** — When you form a hypothesis:
...
5. **Be skeptical of the first explanation** — The first explanation is often wrong, especially when it blames something external. Ask:
...
- Blaming prettier/formatters for "damaging" files without checking your own YAML frontmatter syntax first — this is the team's most common blame target and was wrong every time
