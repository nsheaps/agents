...
description: Procedure for reporting failures to the AI Agent Engineer immediately with full context. Use any time something goes wrong — errors, blockers, spec contradictions, unexpected behavior, coordination issues.
---

# Failure Reporting

Procedure for reporting failures to the AI Agent Engineer. Every failure, no matter how small, must be reported. The AI Agent Engineer records patterns that help the team improve.
...
2. **Message AI Agent Engineer** — Send a message to `ai-agent-engineer` (Wile E. Coyote) with:
...
3. **Also message team-lead** — If the AI Agent Engineer is unavailable or the failure is blocking, message team-lead directly.
...
- Fixing the problem yourself without telling the AI Agent Engineer — even successful recoveries should be logged
- Sending failure reports only to team-lead and skipping the AI Agent Engineer
