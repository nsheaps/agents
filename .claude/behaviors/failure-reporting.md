...
description: Procedure for reporting failures to the AI Agent Eng immediately with full context. Use any time something goes wrong — errors, blockers, spec contradictions, unexpected behavior, coordination issues.
---

# Failure Reporting

Procedure for reporting failures to the AI Agent Eng. Every failure, no matter how small, must be reported. The AI Agent Eng records patterns that help the team improve.
...
2. **Message AI Agent Eng** — Send a message to `ai-agent-eng` (Wile E. Coyote) with:
...
3. **Also message team-lead** — If the AI Agent Eng is unavailable or the failure is blocking, message team-lead directly.
...
- Fixing the problem yourself without telling the AI Agent Eng — even successful recoveries should be logged
- Sending failure reports only to team-lead and skipping the AI Agent Eng
