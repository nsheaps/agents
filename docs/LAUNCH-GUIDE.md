...
| `ai-agent-engineer` | Wile E. Coyote  | AI Agent Engineer | Observes failures, records patterns          |
...
2. **AI Agent Engineer review** — the AI Agent Engineer (Wile E. Coyote) should review any prior session notes in `.claude/tmp/`
