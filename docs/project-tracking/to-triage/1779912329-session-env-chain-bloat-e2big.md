...
- Files Nate manually .bak'd: `/home/nsheaps/.agents/alex/.claude/session-env/6560d0ff-f5b1-4a9c-b585-d996c6a12250.bak` + `/home/nsheaps/.agents/alex/.claude/shell-snapshots/snapshot-zsh-1779911415743-s2c8h7.sh.bak`.

Fix scope: 1pass plugin's SessionStart chain step + possibly launcher-side env hygiene check (warn if CLAUDE_ENV_FILE size > N bytes).
