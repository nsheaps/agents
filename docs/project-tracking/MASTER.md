...
14. create the processing-intake skill (later this will be part of word-vomit)
...
19. Do not let me increase scope, any increase goes in the relevant doc. For now, you'll take notes in open qs in the scratch doc we'll discuss later.

19. For now you'll (alex) be the golden child example of the working agent. We'll extract it out to a template later. 
20. Take note of what the state of the review bot is in nsheaps/agents and other repos and let me know. Test it if you don't know
