...
5. **Event audit trail** — Claude-Flow records every transition as an event.[^1] Our AI Agent Eng role already observes failures, but a structured event log would enable better post-mortem analysis.
