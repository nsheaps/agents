...
#### 3. AI Agent Eng Review (Reactive)

The AI Agent Eng can periodically review public-facing outputs for persona drift:
...
```
Post → Feedback → AI Agent Eng Review → Persona Update → Better Post
```
